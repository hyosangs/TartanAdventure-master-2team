...
public class ItemVendingMachine extends Item implements Shakeable {
    ...
    public void shake() {
        switch (this.count) {
            case 0:
                super.printOut.console("You shake the vending machine, and your favorite treat inches its way off the tray.");
                break;
            case 1:
                super.printOut.console("The treat begins to bend toward the will of gravity.");
                break;
            case 2:
                super.printOut.console("Just as the candy falls, the machine also falls over and crushes you.");
                break;
            default:
                break;
        }
